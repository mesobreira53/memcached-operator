...
import (
	...
	cachev1alpha1 "github.com/mesobreira53/memcached-operator/api/v1alpha1"
	apierrors "k8s.io/apimachinery/pkg/api/errors"
	"k8s.io/apimachinery/pkg/api/meta"
	metav1 "k8s.io/apimachinery/pkg/apis/meta/v1"
)

const memcachedFinalizer = "cache.mes.local/finalizer"
...
// +kubebuilder:rbac:groups=cache.mes.local,resources=memcacheds,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=cache.mes.local,resources=memcacheds/status,verbs=get;update;patch
// +kubebuilder:rbac:groups=cache.mes.local,resources=memcacheds/finalizers,verbs=update
